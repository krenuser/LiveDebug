(function() {
	...
	var B = "	\n\f\r TасЪАсаОтААтАБтАВтАГтАДтАЕтАЖтАЗтАИтАЙтАКтАптБЯуАА\u2028\u2029я¬¬";
	...
	function i(a, b) {
		...
		var c = 2 * b.row - a.start.row - a.end.row;
		return c < 0 ? {
			cursor: a.start,
			anchor: a.end
		} : {
	...
	function h() {
		this.getFoldAt = function(a, b, c) {
			...
			while (e.length) this.expandFolds(e), e = this.getFoldsInRange(c)
	...
	(function() {
		d.implement(this, h), this.EOF_CHAR = "T¦", this.EOL_CHAR = "Tм", this.TAB_CHAR = "тЖТ", this.SPACE_CHAR = "T¬", this.$padding = 0, this.setPadding = function(a) {
		...
		function() {
			...
			var e = this.session.getTokens(b);
